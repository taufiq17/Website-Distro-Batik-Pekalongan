    ...
    <section class="content-header">
      <div class="box box-success box-solid">
        <div class="box-header">
          <h3 class="box-title">Article about batik</h3><br>
          <div class="box-tools pull-right">
            <a role="button" class="btn btn-success" href="aboutadd.php"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add</a>
          </div>
        </div>
        <div class="box-body table-responsive">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php
              ...
              $query = mysqli_query ($connect, "SELECT * FROM about ORDER BY id_artikel DESC");
              $no = 1;
              ...
              while ($data = mysqli_fetch_array($query)) {
                ...
                <tr>
                  <td><?php echo $no; ?></td>
                  <td><img src="../img/artikel/<?php echo $data["foto_artikel"]; ?>" width=40px height=40px></td>
                  <td><?php echo $data["judul"]; ?></td>
                  <td><?php echo substr($data['artikel'],0,50),'...'; ?></td>
                  <td><?php echo $data["tanggal"]; ?></td>
                  <td><?php echo $data["jam"]; ?></td>
                  <td><?php echo $data["oleh"]; ?></td>
                  <td><a class="btn btn-primary btn-sm" role="button" href="aboutup.php?id=<?php echo $data["id_artikel"]; ?>" data-toggle='tooltip' title='Edit'><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>&nbsp;<a onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm" role="button" href="aboutdel.php?id=<?php echo $data["id_artikel"]; ?>" data-toggle='tooltip' title='Delete'><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
                </tr>
