    ...
    $msg = "";
                      ...
                      if (isset($_POST['save'])) {
                        date_default_timezone_set('Asia/Jakarta');
                         ...
                         $folder = "../img/$data[foto_artikel]";
                         if (isset($_POST['img'])) {
                           unlink($folder);

                           $query = mysqli_query($connect, "UPDATE about set foto_artikel = '$namafoto', judul= '$judul', tanggal = '$date', jam = '$time', artikel = '$artikel', oleh = '$oleh' where id_artikel = '$id' ");
                              move_uploaded_file($tmpfoto, $path);
                         }else {
                            $query = mysqli_query($connect, "UPDATE about set judul= '$judul', tanggal = '$date', jam = '$time', artikel = '$artikel', oleh = '$oleh' where id_artikel = '$id' ");
                         }
                          if ($query) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form class="form-horizontal" method="post" enctype="multipart/form-data">
          <h2 class="col-md-offset-2">Update an article about batik</h2>
                    <div class="form-group">
                      <label for="title" class="col-sm-2 control-label">Title</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo $data['judul']; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control" rows="12" name="art"><?php  echo $data['artikel'] ;?></textarea><br>
                        <?php echo $msg; ?>
                      </div>
                   </div>
                   <div class="form-group">
