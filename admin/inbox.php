    ...
    <section class="content-header">
      <div class="box box-success box-solid">
        <div class="box-header">
          <h3 class="box-title">Message from customer</h3>
        </div>
        <div class="box-body table-responsive">
          <table id="example2" class="table table-stripped table-hover">
            ...
            $query = mysqli_query ($connect, "SELECT * FROM inbox ORDER BY id_inbox DESC");
            $no = 1;
            while ($data = mysqli_fetch_array($query)) {
               ...
               <tr>
                 ...
                 <td><a onclick="return confirm('Are you sure?')" class="btn btn-danger" href="inboxdel.php?id=<?php echo $data['id_inbox']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
               </tr>
               <?php $no ++; ?>
            <?php } ?>
              </tbody>
