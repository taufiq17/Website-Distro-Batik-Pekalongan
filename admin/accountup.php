      ...
      $query = mysqli_query($connect, "SELECT * from admin where id_admin = '$id'");
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($error == false) {
                  ...
                  if ($pass == $pass1) {
                    $query = mysqli_query($connect, "UPDATE admin set username= '$name', password = '$pass', email = '$email' where id_admin = '$id' ");
                  ...
                  $msg = "<p class='alert alert-danger'>Your password did not match!</p>";
                }
                }
              }
?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form name="login" method="post" class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3">
            <center><h2>Update an Administrator</h2></center><br>
              <div class="form-group">
              <?php echo $msg; ?>
              <div class="input-group input-group-lg">
                <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
                <input type="text" name="name" class="form-control" placeholder="Username" aria-describedby="basic-addon1" value="<?php echo $data["username"]; ?>">
              </div><br>
              <div class="input-group input-group-lg">
                <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></span>
                <input type="password" name="pass1" class="form-control" placeholder="Your old password" aria-describedby="basic-addon1">
              </div><br>
               <div class="input-group input-group-lg">
                <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></span>
                <input type="password" name="pass" class="form-control" placeholder="Your new password" aria-describedby="basic-addon1">
              </div><br>
              <div class="input-group input-group-lg">
                <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></span>
                <input type="email" name="email" class="form-control" placeholder="Email" aria-describedby="basic-addon1" value="<?php echo $data["email"]; ?>">
              </div>
            </div>
            <input type="submit" name="submit" class="btn btn-primary btn-lg col-xs-4 col-xs-offset-4 col-md-4 col-md-offset-4" value="Update">
          </form>
