      ...
      <!-- BEGIN SIDEBAR & CONTENT -->
        ...
        <!-- END SALE PRODUCT & NEW ARRIVALS -->
            ...
            <?php 
              ...
              $querypro = mysqli_query($connect, "SELECT * FROM barang WHERE id_kategori = 1 ORDER BY id_barang DESC LIMIT $start, $perpage");
                  ...
                  <div class="col-xs-12">
                    ...
                    <ul class="pagination pagination-lg">
                      <?php
                          ...
                          for($i = 1; $i <=$halaman; $i++){
                            echo "<li><a href='index.php?page=pria&hal=$i'> $i </a></li>";
                          }
                       ?>
                    </ul>
                  </nav>
